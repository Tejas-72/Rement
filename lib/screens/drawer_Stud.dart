...
class MenuDrawer_stud extends StatelessWidget {
  const MenuDrawer_stud({Key? key}) : super(key: key);
  ...
  void onItemPressed(BuildContext context,{required int index}){
    ...
    switch(index){
      case 0: Navigator.push(context, MaterialPageRoute(builder: (context) =>  UsrHome_stud()));
      break;
